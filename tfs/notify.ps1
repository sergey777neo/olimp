...
Invoke-WebRequest -Uri  https://api.github.com/repos/ddrakonn/olimp/statuses/$(Build.SourceVersion) -Method POST -Headers $headers -Body $JSON -MaximumRedirection 0 -ErrorVariable Err
